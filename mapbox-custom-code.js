  ...
  if (features.length) {
    for (const feature of features) {
      ...
      if (
        ...
        itemLink.innerHTML = `<div class="title-wrapper-listing"><div class="list-blue-title"><img src="https://uploads-ssl.webflow.com/6352289bab9b05d2a93f26f6/6381d0540b97f64a21ba378f_Vector-2.svg" loading="eager" alt="" class="listing-icon"><p class="bold-listing-title-mil"> ${feature.properties.Type} | ${feature.properties.Group} <br><span class="group-name-span">${feature.properties.TerroristGroupTags}</span></p></div><div class="subtitle-wrapper"><div class="listing-subtitle-wrapper"><img src="https://uploads-ssl.webflow.com/6352289bab9b05d2a93f26f6/6381d05476687c4b80d38c3a_Vector-1.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.formatted_date}</p></div><div class="listing-subtitle-wrapper"><img src="https://uploads-ssl.webflow.com/6352289bab9b05d2a93f26f6/6381d05442077f1bb5a0e8a2_Vector.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.Geocode_Name}</p></div></div></div><p class="listing-text">${feature.properties.Notes}</p>`;
      } else {
