  ...
  if (features.length) {
    for (const feature of features) {
      ...
      if (
        ...
        itemLink.innerHTML = `<div class="title-wrapper-listing"><div class="list-blue-title"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46abd14020aa9b1fe30_handcuffs-svgrepo-com.svg" loading="eager" alt="" class="listing-icon"><p class="bold-listing-title-mil"> ${feature.properties.Type} | ${feature.properties.Group} <br><span class="group-name-span">${feature.properties.TerroristGroupTags}</span></p></div><div class="subtitle-wrapper"><div class="listing-subtitle-wrapper"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46abd1402883db1fe31_date-icon.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.formatted_date}</p></div><div class="listing-subtitle-wrapper"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46bbd14021eb9b1fe32_error-map-location-icon.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.Geocode_Name}</p></div></div></div><p class="listing-text">${feature.properties.Notes}</p>`;
      } else {
        itemLink.innerHTML = `<div class="title-wrapper-listing"><div class="list-blue-title"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46abd14020aa9b1fe30_handcuffs-svgrepo-com.svg" loading="eager" alt="" class="listing-icon"><p class="bold-listing-title-idf"> ${feature.properties.Type} | ${feature.properties.Group} <br><br><span class="group-name-span">${feature.properties.TerroristGroupTags}</span></p></div><div class="subtitle-wrapper"><div class="listing-subtitle-wrapper"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46abd1402883db1fe31_date-icon.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.formatted_date}</p></div><div class="listing-subtitle-wrapper"><img src="https://assets.website-files.com/6352289bab9b05d2a93f26f6/6380e46bbd14021eb9b1fe32_error-map-location-icon.svg" loading="eager" alt="" class="listing-sub-icon"><p class="bold-listing-subtitle">${feature.properties.Geocode_Name}</p></div></div></div><p class="listing-text">${feature.properties.Notes}</p>`;
      }
